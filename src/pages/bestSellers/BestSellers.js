...
const BestSellers = ({ title, imageDetailsClass }) => {
  const initialState = {
    men1: mensDress1,
    child1: childDress1,
            ...
            return (
              <div className="carouselItems-list-parent">
                <div className="carouselItems-Details">
                  ...
                  <div
                    className={`imageDetails-parent ${
                      imageDetailsClass ? imageDetailsClass : ""
                    }`}
                  >
                    ...
                    <div className="product-parent-container">
                      <div className="product-prize-container">
                        <div className="product-original">
                          <s>
                            ₹{carouselItem?.imageDetails?.productOriginalPrice}
                            .00
                          </s>
                        </div>
                      ...
                      >
                        <div className="layerIconParent">
                          <LayersOutlinedIcon class="layerIcon" />
                        </div>
                      </Tooltip>
                    </div>
                  </div>
                </div>
                <div className="extraProduct-details">
                  <Tooltip
                    title={
                      carouselItem?.imageDetails?.detailsCategories?.categoryOne
                    }
                    arrow
                    placement="bottom"
                    componentsProps={{
                  ...
                  >
                    <div>
                      {
                        carouselItem?.imageDetails?.detailsCategories
                          ?.categoryOne
                      }
                    </div>
                  </Tooltip>
                  <Tooltip
                    title={carouselItem?.imageDetails?.detailsCategories
                          ?.categoryTwo}
                    arrow
                    placement="bottom"
                    componentsProps={{
